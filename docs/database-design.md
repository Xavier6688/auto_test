...
### 2.9 shared_components — 公共组件表（新增）
...
### 2.11 suite_scripts — 套件-脚本关联表（新增）
...
### 2.13 environment_configs — 环境配置表（新增）
...
### 2.15 script_versions — 脚本版本历史表（新增）
...
### 2.17 llm_usage_logs — LLM 调用记录表（新增）
